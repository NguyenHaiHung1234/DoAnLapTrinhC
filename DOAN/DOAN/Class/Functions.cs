...
using DOAN.Class;
using COMException = Microsoft.Office.Interop.Excel;
...
namespace DOAN.Class
{
    internal class Functions
    {
        ...
        public static void Connect()
        {
            ...
            Con.ConnectionString = @"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=D:\NguyenHaiHung_2121110142\DOAN\DOAN\Quanlybanhang.mdf;Integrated Security=True;Connect Timeout=30";
